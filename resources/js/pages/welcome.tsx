            ...
            >
                ...
                <div className="relative z-10 flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-[#0b2431] p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(55,198,232,0.3)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#091e28] dark:text-[#d7f4ff] dark:shadow-[inset_0px_0px_0px_1px_rgba(55,198,232,0.25)]">
                            <h1 className="mb-1 font-medium">
                                Let's get started
                            </h1>
                            <p className="mb-2 text-[#8cc9d8] dark:text-[#8cc9d8]">
                                Laravel has an incredibly rich ecosystem.
                                <br />
                                We suggest starting with the following.
                            </p>
                            <ul className="mb-4 flex flex-col lg:mb-6">
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-l before:border-[#2a6a80] dark:before:border-[#2a6a80]">
                                    <span className="relative bg-[#0b2431] py-1 dark:bg-[#091e28]">
                                        <span className="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-[#2a6a80] bg-[#081b24] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.2),0px_1px_2px_0px_rgba(0,0,0,0.35)] dark:border-[#2a6a80] dark:bg-[#081b24]">
                                            <span className="h-1.5 w-1.5 rounded-full bg-[#37c6e8] dark:bg-[#37c6e8]" />
                                        </span>
                                    </span>
                                    <span>
                                        Read the
                                        <a
                                            ...
                                            target="_blank"
                                            className="ml-1 inline-flex items-center space-x-1 font-medium text-[#37c6e8] underline underline-offset-4 dark:text-[#37c6e8]"
                                        >
                                ...
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-0 before:bottom-1/2 before:left-[0.4rem] before:border-l before:border-[#2a6a80] dark:before:border-[#2a6a80]">
                                    <span className="relative bg-[#0b2431] py-1 dark:bg-[#091e28]">
                                        <span className="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-[#2a6a80] bg-[#081b24] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.2),0px_1px_2px_0px_rgba(0,0,0,0.35)] dark:border-[#2a6a80] dark:bg-[#081b24]">
                                            <span className="h-1.5 w-1.5 rounded-full bg-[#37c6e8] dark:bg-[#37c6e8]" />
                                        </span>
                            ...
                            <ul className="flex gap-3 text-sm leading-normal">
                                <li>
                                    <a
                                        ...
                                        target="_blank"
                                        className="inline-block rounded-sm border border-[#37c6e8] bg-[#0c3b4a] px-5 py-1.5 text-sm leading-normal text-white hover:border-[#5fe3ff] hover:bg-[#0a3240] dark:border-[#37c6e8] dark:bg-[#0c3b4a] dark:text-white dark:hover:border-[#5fe3ff] dark:hover:bg-[#0a3240]"
                                    >
                                        Deploy now
                                    </a>
                                </li>
                        ...
                        <div className="relative -mb-px aspect-[335/376] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#0a2230] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#071b24]">
                            <svg
                                className="w-full max-w-none translate-y-0 text-[#37c6e8] opacity-100 transition-all duration-750 dark:text-[#5fe3ff] starting:translate-y-6 starting:opacity-0"
                                viewBox="0 0 438 104"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
