...
export interface SharedData {
    ...
    dashboardTranslations?: {
        ...
        appointments_create_field_patient_id?: string;
        appointments_create_patient_placeholder?: string;
        appointments_create_patient_required?: string;
        appointments_create_verify_patient?: string;
        appointments_create_patient_valid?: string;
        appointments_create_patient_not_found?: string;
        appointments_create_patient_no_history?: string;
        appointments_create_patient_verify_error?: string;
        appointments_create_field_reason?: string;
        appointments_create_field_current_illness?: string;
        appointments_create_field_diagnosis?: string;
        appointments_create_field_discharge_date?: string;
        appointments_create_field_discharge_summary?: string;
        appointments_create_field_discharge_reason?: string;
        appointments_create_cancel?: string;
        appointments_create_submit?: string;
        platform?: string;
        repository?: string;
